...
class arMigration0170
{
  ...
  public function up($configuration)
  {
    ...
    $criteria->add(QubitTermI18n::NAME, 'Local file');
    $criteria->add(QubitTermI18n::CULTURE, 'en');

    if (null === QubitTerm::get($criteria))
    {
      // Create new term for local file digital object usage
      QubitMigrate::bumpTerm(QubitTerm::LOCAL_FILE_ID, $configuration);
      $term = new QubitTerm;
      $term->id = QubitTerm::LOCAL_FILE_ID;
